...
namespace CMS2.Controllers
{
    public class CrisesController : Controller
    {
        ...
        {
            var crises = db.Crises.Include(c => c.AssistanceRequired);
        ...
        public ActionResult Create([Bind(Include = "Id,CallerName,CallerNumber,Location,Description,LevelOfEmergencyId,AssistanceRequiredId")] Crisis crisis)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CallerName,CallerNumber,Location,Description,LevelOfEmergencyId,AssistanceRequiredId")] Crisis crisis)
        {
            if (ModelState.IsValid)
            {
